...
@Component
public class RecurrenceCreditAndDebitCardPayOverDueScheduled {

   private static final Logger LOGGER = LoggerFactory.getLogger(RecurrenceCreditAndDebitCardPayOverDueScheduled.class);
   ...
   /**
    * Faz os pagamentos das faturas de cartao de credito/debito que estão com até 90 dias de vencida.
    */

   @Scheduled(cron = "0 0 8,20 * * * ", zone = TIME_ZONE)
   ...
   public void run() {
      ...
      try {
         ...
         List<BigInteger> invoices = invoiceService.listInvoicesToRecurrenceReponsibleFinancial(begin, end, false);
